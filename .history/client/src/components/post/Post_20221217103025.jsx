...
export default function Post({ post }) {
  ...
  const handleClickShowUpdate = async () => {
    setShowPostUpdate(!showPostUpdate);
    const resPost = await axios.get(`/posts/${post?._id}`);
    const resUser = await axios.get(`/users?userId=${post.userId}`);
    ...
    <div className="post">
      <div className="postWrapper">
        <div className="postTop">
          ...
          {showPostUpdate && dataPostOne?.userId === dataUserOne?._id && (
            <ModalShare
              ...
              <>
                <div className="modal-share--info">
                  ...
                  <span className="modal-share--name">
                    {dataUserOne?.username}
                  </span>
                </div>
                <input
                  placeholder={`${dataUserOne?.username} ơi, bạn đang nghĩ gì thế?`}
