...
export default function Post({ post }) {
  ...
  useEffect(() => {
    const fetchDataComment = async () => {
      const res = await axios.get(`api/comments/63a09125669b1829f47cd4ef`);
      setcommentData(res?.data);
      console.log("🚀 ~ file: Post.jsx:218 ~ fetchDataComment ~ res", res);
    };
    fetchDataComment();
  }, [post?._id]);
      ...
      <div className="postWrapper">
        ...
        <div className="postWatch">
          <div className="postWatch-item">
            <span className="postWatch-item--icon" onClick={() => Likehandle()}>
              <BiLike />
            </span>
