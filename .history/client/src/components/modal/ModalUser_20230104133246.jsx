...
const ModalUser = ({ userId, heading = "", closeModal = () => {} }) => {
  ...
  useEffect(() => {
    reset(currentUser);
    setValueDate(currentUser?.birthDate);
  }, [currentUser, reset]);
  ...
  const handleSubmitUser = async (values) => {
    ...
    try {
      const res = await axios.put(`/users/${userId}`, updateValue);
      // localStorage.setItem(
      console.log("🚀 ~ file: ModalUser.jsx:85 ~ handleSubmitUser ~ res", res);
      //   "user",
      //   JSON.stringify({ ...currentUser, updateValue })
      // );
      closeModal();
    } catch (error) {
      console.log(error);
        ...
        <div className="modal-share--user">
          ...
          >
            ...
            <div className="modal-user--form-group">
              ...
              <div className="modal-user--group">
                <Label htmlFor="company">Ngày sinh</Label>
