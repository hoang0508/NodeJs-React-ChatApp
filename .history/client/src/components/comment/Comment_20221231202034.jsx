...
const Comment = ({ post, countComment, commentData, setcommentData }) => {
  const { user: currentUser, handleFileImage, file } = useContext(AuthContext);
  ...
  const handleFileImageComment = (e, id) => {
    handleFileImage(e);
  ...
  console.log(post?._id === imageIdComment);
              ...
              <div className="comment-input--select">
                <label htmlFor="file" className="">
                  ...
                  <input
                    ...
                    id="file"
                    accept=".png,.jpeg,.jpg"
                    onChange={(e) => handleFileImageComment(e, post?._id)}
                  />
                </label>
                <span onClick={() => setToggleEmoji(!toggleEmoji)}>
                      ...
                      <div className="comment-content--list">
                        ...
                        {item?.imageComent !== " " && (
                          <div className="comment-content--image">
                            <img src={PF + item?.imageComent} alt="" />
                          </div>
                        )}
                        <div className="comment-content--time">
                          <span>Thích</span>
