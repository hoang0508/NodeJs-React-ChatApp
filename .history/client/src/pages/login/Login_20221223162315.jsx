...
export default function Login() {
  ...
  const handleSubmitLogin = async (value) => {
    try {
      ...
      const userCheck = JSON.parse(localStorage.getItem("user")) || null;
      console.log(
        "🚀 ~ file: Login.jsx:54 ~ handleSubmitLogin ~ userCheck",
        userCheck
      );
      if (userCheck !== null) {
        toast.success("Đăng nhập thành công!!");
      } else {
        toast.error("Đăng nhập thất bại!!, bạn cần kiểm tra lại tài khoản...");
      }
    } catch (error) {
